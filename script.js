...
//         // This code runs AFTER the slide animation ends
//         if ($(this).is(":visible")) {
...
// });
/* ===============================
   2. MOBILE MENU TOGGLE (Rewritten)
=============================== */
$(".menu-trigger").on("click", function (event) {
    // Prevent default anchor behavior if needed
    event.preventDefault(); 

    // Toggle 'active' state on the trigger icon
    $(this).toggleClass("active");
       // 2. Toggle icons: Hide the menu bar and show the close "X" (and vice versa)
    $(this).find(".ri-menu-line, .ri-close-line").toggle();
    // Toggle the 'menu-open' class on the .nav element (triggers CSS slide)
    $(".nav").toggleClass("menu-open");

    // Toggle the main logo visibility (display: none/block)
    // $(".logo-it").toggle();
});
// ------------------
